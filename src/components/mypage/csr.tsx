...
export const MyPageEditInfoComponent = () => {
  ...
  const { email, loginPlatform, generatedPlatform } = useAuth()
  const isOotdGenerated = generatedPlatform[0].ootd
  const isKakaoGenerated = generatedPlatform[1].kakao
  const isGoogleGenerated = generatedPlatform[2].google
    ...
    <div className='w-[100%] h-[500px] flex my-[30px]'>
      ...
      <section className='w-[50%] h-[100%] p-[30px]'>
        <div className='flex flex-col gap-[60px]'>
          ...
          { isGoogleGenerated !== null  ? 
          <div className='w-full h-[60px] flex items-center justify-center rounded-md bg-white shadow-md'>
              <div className='inline-block mr-[10px]'>
              ...
              <span className='font-semibold text-black'>이미 구글 계정에 연동 되어있습니다.</span>
            </div>
          :
          ...
          {
            isKakaoGenerated !== null ?
            <div 
              className='w-full h-[60px] flex items-center justify-center rounded-md shadow-md bg-[#fae302]'
            >
              <div className='inline-block mr-[10px]'>
                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 48 48">
              ...
              <span className='font-semibold text-black'>이미 카카오 계정에 연동 되어있습니다.</span>
            </div>
              :
