        ...
        <div className='flex-1 flex flex-col gap-[20px]'>
          <div className='flex items-center justify-between'>
            <div className='text-[20px] font-semibold'>
              ...
              <span className='font-bold' style={{ color: EVENT_COLOR }}>1</span>
              <span className='font-bold' style={{ color: EVENT_COLOR }}>개 : </span>
              <span>668,330</span>
              <span>원</span>
            </div>
            <button className='w-[110px] h-[50px] flex items-center border border-[#CFD5DB] rounded-md justify-center text-[14px] font-semibold'>
              <span>선택 삭제</span> 
          ...
          <ul className='w-[100%]  border border-[#dde0e3]'>
            <li className='flex w-[100%] h-[70px] bg-[#F7F8F9] border-b border-[#dde0e3]'>
              <div className='relative w-[5%] h-[100%] flex items-center justify-center text-[#aeb5bb]  '>
                <input type="checkbox" name="" id="CheckAllCartItem" className='relative default:ring-2 border border-[#aeb5bb] checked:border-none w-[25px] h-[25px] appearance-none rounded-sm checked:bg-[#7732FF]'/>
              ...
              <div className='w-[40%] h-[100%] flex items-center justify-center border-l border-l-[#dde0e3]'>
                <span className='font-bold text-[17px]'>상품정보</span>
              </div>
              <div className='w-[10%] h-[100%] flex items-center justify-center border-l border-l-[#dde0e3]'>
              ...
              <div className='w-[15%] h-[100%] flex items-center justify-center border-l border-l-[#dde0e3]'>
            ...
            {testArray.map((item, index) => (
              <li key={index} className='w-[100%] h-[150px] flex items-center border-b border-b-[#dde0e3]'>
                <div className='w-[5%] h-[100%] flex items-center justify-center text-[#aeb5bb]  '>
                  <input type="checkbox" name="" id={`item${index}`} className='relative default:ring-2 border border-[#aeb5bb] checked:border-none w-[25px] h-[25px] appearance-none rounded-sm checked:bg-[#7732FF]'/>
                  <label htmlFor={`item${index}`} className="absolute cursor-pointer z-10  ">
                    <FontAwesomeIcon icon={faCheck} className='w-[15px] h-[15px] text-[15px] checked:text-white'/>
                  </label>
                </div>
                <div className='w-[40%] h-[100%] flex items-center justify-between border-l border-l-[#dde0e3] p-[30px]'>
                  ...
                  <div className='w-[240px] h-[100%] flex flex-col items-start justify-center'>
                    ...
                    <span>클라우디아 여성 패딩 블랙</span>
                  </div>
                  <div className='w-[260px] h-[100%] bg-red-500'>

                  </div>
                </div>
                <div className='w-[10%] h-[40%] flex items-center justify-center border-l border-l-[#dde0e3] text-[14px]'>
                ...
                <div className='w-[10%] h-[80%] flex flex-col items-center justify-center border-l border-l-[#dde0e3] text-[15px]'>
                ...
                <div className='w-[15%] h-[50%] flex items-center justify-center border-l border-l-[#dde0e3]'>
                  <span className='font-bold text-[17px]'>668,330<span>원</span></span>
                </div>
                <div className='w-[10%] h-[50%] flex items-center justify-center border-l border-l-[#dde0e3]'>
          ...
          <div className='w-[100%] h-[300px]  flex-col'>
            ...
            <div className='flex-1 border border-[#dde0e3] flex'>
              <div className='w-[30%] h-[100%] flex flex-col  justify-center gap-[10px] bg-[#F7F8F9] py-[20px] px-[40px]'>
                <div className='flex items-center justify-between'>
                  <span>주문 상품 수</span>
                  <span>1
                    <span>개</span>
