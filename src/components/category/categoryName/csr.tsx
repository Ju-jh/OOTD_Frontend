...
export default function CategoryNameComponent({ categoryParma }: Data) {
  ...
  return (
    <div className="flex justify-between place-items-center w-full h-[60px] bg-gray-300 text-[24px] bord">
      <p>{categoryParma}</p>
      <div className="flex text-[16px]">
        ...
        <ul className={isButton == false ? "absolute w-[120px] mt-[25px] right-[35px] border-solid border-1 rounded-md bg-white" : "hidden"}>
          <li className={`p-[5px] cursor-pointer ${isList == "인기순" ? "font-bold":""}`} onClick={() => listBtn("인기순")}>인기순</li>
          <li className="p-[5px] cursor-pointer" onClick={() => listBtn("최신순")}>최신순</li>
          <li className="p-[5px] cursor-pointer" onClick={() => listBtn("장바구니 많은 순")}>장바구니 많은 순</li>
          <li className="p-[5px] cursor-pointer" onClick={() => listBtn("찜 많은 순")}>찜 많은 순</li>
          <li className="p-[5px] cursor-pointer" onClick={() => listBtn("가격낮은순")}>가격낮은순</li>
          <li className="p-[5px] cursor-pointer" onClick={() => listBtn("가격높은순")}>가격높은순</li>
          <li className="p-[5px] cursor-pointer" onClick={() => listBtn("정확도")}>정확도</li>
        </ul>
      </div>
    </div>
  );
